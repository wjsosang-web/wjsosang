                  ...
                  <li key={n.id} className="border-b border-line first:border-t">
                    ...
                    >
                      <span className="flex items-start gap-2 sm:contents">
                        ...
                        <span className="min-w-0 flex-1 text-[14px] font-semibold leading-snug transition-colors group-hover:text-brand sm:truncate sm:text-[14.5px]">
                          {n.title}
                        </span>
                      </span>
                      <span className="tnum mt-1.5 block pl-[52px] text-[12px] text-muted sm:mt-0 sm:shrink-0 sm:pl-0 sm:text-[12.5px]">
                        {formatDate(n.date)}
                      </span>
                    </Link>
                  </li>
